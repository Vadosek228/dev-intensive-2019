...
class ProfileActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initViewModel()
        Log.d("M_ProfileActivity", "onCreated")
    }
    ...
    private fun updateTheme(mode: Int) {
        ...
        delegate.setLocalNightMode(mode) //каждый раз происходит пересоздание активити ! Но для замены темы
    }
        ...
        with(btn_edit) {
            val filter: ColorFilter? = if(isEdit){
                PorterDuffColorFilter(
                    ...
                    PorterDuff.Mode.SRC_IN //принимает режим наложения
                )
    ...
    private fun updateUI(profile: Profile) {
        ...
        iv_avatar.updateAvatar(initials, theme)
    }
